...
import com.schedulev2.schedule.databinding.V2DrawerLayoutHeaderBinding
import com.schedulev2.schedule.databinding.V2PartNavigationDrawerContainerFragmentBinding
import com.schedulev2.schedule.v1.ScheduleFragmentContract
import com.schedulev2.schedule.v2.ScheduleFragmentV2V2
import com.schedulev2.schedule.v2.container.adapter.PressItemDelegate
import com.schedulev2.schedule.v2.container.adapter.TitleDelegate
import com.schedulev2.schedule.v2.container.adapter.model.SettingsDrawerItem
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        if (fragment == null)
            childFragmentManager.beginTransaction().apply {
                replace(
                    com.schedulev2.schedule.R.id.navigationDrawerContainer,
