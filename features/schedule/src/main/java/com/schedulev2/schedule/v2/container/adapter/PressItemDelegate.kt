package com.schedulev2.schedule.v2.container.adapter
...
import com.schedulev2.schedule.databinding.V2ItemDrawerPressBinding
...
class PressItemDelegate(
    ...
    override fun onClick(p0: View?) {
        if (p0?.id == com.schedulev2.schedule.R.id.pressItem) onItemClick.invoke()
