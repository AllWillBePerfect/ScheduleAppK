...
import com.schedulev2.schedule.databinding.CustomTabBinding
import com.schedulev2.schedule.databinding.V2FragmentScheduleBinding
...
import com.schedulev2.schedule.v2.adapter.viewpager.adapter.RecyclerViewDayAdapter
...
import com.schedulev2.schedule.v2.search.SearchFragment
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        if (fragment == null)
            childFragmentManager.beginTransaction().apply {
                replace(com.schedulev2.schedule.R.id.v2_inner_fragment, SearchFragment(), TAG)
                commit()
            }
