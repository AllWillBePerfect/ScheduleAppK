...
import com.schedule.schedule.v1.adapter.ScheduleAdapter
import com.schedule.schedule.databinding.DrawerLayoutHeaderBinding
import com.schedule.schedule.databinding.FragmentScheduleBinding
...
class ScheduleFragment : Fragment() {
    ...
    private fun setupDrawerLayout() {
        ...
        toggle = ActionBarDrawerToggle(
            requireActivity(),
            drawerLayout,
            com.schedule.values.R.string.openDrawer,
            com.schedule.values.R.string.closeDrawer
        )
        ...
        navView.setNavigationItemSelectedListener {
            when (it.itemId) {
                com.schedule.values.R.id.settings_option -> {
...
//            adapter.submitList(createList())
    ...
    val myMenuProvider = object : MenuProvider {
        override fun onCreateMenu(menu: Menu, menuInflater: MenuInflater) {
            menu.clear()
            menuInflater.inflate(com.schedule.values.R.menu.app_bar_menu, menu)
        }

        override fun onMenuItemSelected(menuItem: MenuItem): Boolean {
            return when (menuItem.itemId) {
                com.schedule.values.R.id.settings_IconButton -> {
