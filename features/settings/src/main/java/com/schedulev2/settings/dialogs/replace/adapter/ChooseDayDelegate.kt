package com.schedulev2.settings.dialogs.replace.adapter
...
import com.schedulev2.settings.databinding.V2ItemChooseDayBinding
...
class ChooseDayDelegate(
    ...
    override fun onClick(p0: View?) {
        if (p0?.id == com.schedulev2.settings.R.id.v2_item_choose_day)
