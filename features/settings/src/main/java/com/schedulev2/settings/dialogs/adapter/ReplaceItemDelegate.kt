package com.schedulev2.settings.dialogs.adapter
...
import com.schedulev2.settings.databinding.V2ItemReplaceBinding
import com.schedulev2.settings.dialogs.adapter.model.GroupItem
import com.schedulev2.settings.dialogs.replace.adapter.ChooseDayDelegate
...
class ReplaceItemDelegate(private val onItemClickListener: (GroupItem.Replace) -> Unit) : AdapterItemDelegate<GroupItem>, OnClickListener {
    ...
    override fun onClick(p0: View?) {
        if (p0?.id == com.schedulev2.settings.R.id.v2_item_replace) {
