package com.example.settings.dialogs
...
open class BaseDialogFragment<T : ViewBinding>(
    ...
    override fun onCreateView(
        ...
        dialog?.window?.setBackgroundDrawable(ContextCompat.getDrawable(requireContext(), com.example.settings.R.drawable.dialog_corners_bg))
