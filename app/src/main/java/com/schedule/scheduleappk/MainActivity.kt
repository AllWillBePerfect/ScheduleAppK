package com.schedule.scheduleappk
...
import com.schedule.clear.ClearFragment
...
import com.schedule.scheduleappk.workmanager.SomeWorkManager
import com.schedule.utils.nightmode.NightModeUtils.setupNightMode
...
//        applyNightAfterOnCrete(settingsOptionRepository.getNightModeInt())
        ...
        if (dynamicColorsRepository.getDynamicColorsState())
            setTheme(com.schedule.values.R.style.Theme_ScheduleAppK_DynamicColors)
        else
            setTheme(com.schedule.values.R.style.Theme_ScheduleAppK)
